# TODO: Translation updated at 2022-11-18 03:04
translate chinese strings:
  ...
  new "菜单中的选项用于提升访问性。这些选项不一定适用于所有游戏。部分选项组合会导致游戏崩溃。这并非是游戏或游戏引擎的问题。为达到最佳效果，在更改字体以后，请尽可能保留原始的字体大小。"
  ...
  new "本程序所用的免费软件使用了不同的许可协议，包括 MIT 协议和 GNU 通用公共许可协议。完整的软件名单及源码链接请参阅{a=https://www.renpy.org/l/license}此链接{/a}。"
  ...
  new "自动语音将播放 \"[renpy.display.tts.last]\"。按“alt+shift+V”禁用。"
